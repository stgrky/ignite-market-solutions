...
export const system = {
  ...
  note: "Start with the base site. It's complete and ready to go on its own, and anything you want beyond it, I build on top, quoted as custom development at $60/hour. Your build includes two hours of revisions, so the changes you have in mind may not cost anything extra. Want something fully custom instead — from scratch, or on a site you already have? That's $60/hour too, with a paid discovery hour first for a site I didn't build. Everything is agreed in writing before work starts.",
};
...
export const pricing = {
  ...
  addOnsCustomNote:
    "Need something that isn't listed? I'll build it on top of your website, quoted as custom development at $60/hour — and your two included revision hours may cover it. Fully custom work, from scratch or on a site you already have, is $60/hour too, with a paid discovery hour first for a site I didn't build. Content writing, broader SEO, and most other digital work are quoted per project. Bring it up on your intro call and you'll get a straight price in writing before anything starts.",
  addOnsNote:
